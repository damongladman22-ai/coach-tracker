      ...
      {step === 'upload' && (
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <label className="block">
            <div className="border-2 border-dashed border-blue-400 rounded-lg p-8 text-center cursor-pointer hover:bg-blue-50 hover:border-blue-500 transition-colors">
              <svg
